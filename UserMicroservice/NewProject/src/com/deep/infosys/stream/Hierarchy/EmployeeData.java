...
public class EmployeeData {
    ...
    public static List<Employee> getEmployees() {
        ...
        return Arrays.asList(
                ...
                new Employee(5, "Rahul", "IT", 70000, 28, 2,
                        Arrays.asList("Java", "Spring")),
                new Employee(6, "Sneha", "IT", 75000, 30, 2,
                        Arrays.asList("AWS", "Microservices")),
                new Employee(7, "Vikas", "IT", 65000, 27, 2,
                        Arrays.asList("React", "Node")),

                // TEAM UNDER MANAGER — HR TEAM (managerId = 3)
                new Employee(8, "Anjali", "HR", 55000, 29, 3,
                        Arrays.asList("Recruitment")),
                new Employee(9, "Tarun", "HR", 50000, 26, 3,
                        Arrays.asList("Training")),

                // TEAM UNDER MANAGER — FINANCE TEAM (managerId = 4)
                new Employee(10, "Kiran", "Finance", 60000, 32, 4,
                        Arrays.asList("Accounts")),
                new Employee(11, "Manoj", "Finance", 65000, 35, 4,
                        Arrays.asList("Taxation")),

                // EXTRA TEAM LEAD LEVEL (optional deeper hierarchy)
                new Employee(12, "Deepak", "IT", 90000, 38, 2,
                        Arrays.asList("DevOps", "Cloud")),
                new Employee(13, "Rohit", "IT", 40000, 24, 12,
                        Arrays.asList("HTML", "CSS", "JavaScript")),
                new Employee(14, "Meena", "IT", 42000, 23, 12,
